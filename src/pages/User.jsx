      ...
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mb-8 md:gap-8">
          <div className="mb-6 md:mb-0">
            <div className="relative shadow-xl image-full">
              <figure>
                <img className="rounded-lg" src={avatar_url} alt="" />
              </figure>
              <div className="w-full h-full absolute top-0 flex flex-col justify-end p-4 text-white bg-slate-800 bg-opacity-40">
